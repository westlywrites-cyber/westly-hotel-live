...
import { Coffee, History, Clock } from "lucide-react";
...
export default function WaiterDashboard() {
  ...
  const { data: orders, loading, error } = useCollection("orders", adminUser ? [where("waiterId", "==", adminUser.id)] : []);
  ...
  return (
    <div className="space-y-6">
      ...
      {loading ? (
        ...
        <DataError message="We couldn't load your orders." />
      ) : (
