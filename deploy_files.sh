...
# ── Config: source (repo root) → destination (relative to artifacts/Westly-Hotel/) ──
APP_ROOT="artifacts/Westly-Hotel"

declare -A FILES=(
  ["diagnostics.ts"]="src/lib/diagnostics.ts"
  ["useAsyncAction.ts"]="src/hooks/useAsyncAction.ts"
  ["DiagnosticsPage.tsx"]="src/pages/admin/DiagnosticsPage.tsx"
